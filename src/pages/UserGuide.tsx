...
const Index = () => {
	return (
		<div className="bg-[#06002B] min-h-screen w-full relative">
			<Navbar />
			<Part />
			<div className="container md:px-20 mx-auto flex flex-col md:flex-row p-4 md:p-10 md:pt-14 gap-4">
			...
			<div className="container md:px-20 mx-auto p-4 gap-4 md:p-10">
