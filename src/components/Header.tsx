					...
					<div className="absolute inset-9 flex flex-col md:flex-row items-center justify-between z-10 w-fit md:w-full md:px-8">
						...
						<div className="md:w-1/2 mb-4 md:mb-0">
							...
							<div className="w-full flex mt-6 md:mt-10 gap-3 justify-start items-center">
								<button className="px-2 md:px-10 py-2 md:py-3 whitespace-nowrap md:font-semibold bg-white rounded-md border-2 text-[#007BFF] hover:bg-[#53A6FF] hover:border-[#007BFF] shadow-sm shadow-[#53A6FF] transition-all duration-150 ease-in-out">
									Get Started
								</button>
